...
学位論文や投稿論文には一定の様式があるため、その様式に則って書かれていることが前提である。
...
### 考察の書き方
考察に書ける内容は以下の三つに分けられる
  1. 結果から当然導かれる自明な結論については、そのまま結果に記載することが望ましい。
  1.  複数の結果や、章を横断・総合して導かれる自身の意見、推察については考察に記載すること。
  1.  本研究での新知見と、別論文の結果・考察から自身の意見や推察を記載する。
...
実験計画を立てる場合は節を設置して整理するが、学位論文執筆のときには節構造は取り払い、学術論文のように構成する
