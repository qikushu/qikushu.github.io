...
1. 段落の設定を選択し、固定値の22ポイントに設定する。フォントが10ポイントなので、その倍がダブルスペース。
...
### 表
育種学研究の投稿規程に従う。
詳しくは、Theoretical and Applied Geneticsの投稿規程に詳細が書いてある。
